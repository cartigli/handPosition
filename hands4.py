...
"""
test loss: 0.2884; test avg. pixel err: 3.9933 (pixel_error: 8.9415)
test loss: 0.3815; test avg. pixel err: 4.6580 (pixel_error: 10.4289)
test loss: 0.3736; test avg. pixel err: 4.5666 (pixel_error: 10.2275)
test loss: 0.2799; test avg. pixel err: 3.9364 (pixel_error: 8.8089) pretty volatile, epochs 5 -> 7
test loss: 0.3372; test avg. pixel err: 4.3461 (pixel_error: 9.7245)
""" # 3 -> 4 added another conv2d layer: 2048 -> 4096
...
def main():
	...
	# lr_sched = tf.keras.optimizers.schedules.ExponentialDecay(
		...
		# decay_rate=0.98
	# )
	# lr_opt = tf.keras.optimizers.Adam(learning_rate=lr_sched)
