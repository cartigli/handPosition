...
test loss: 0.3202; test avg. pixel err: 4.2345 (pixel_error: 9.4802)
test loss: 0.3163; test avg. pixel err: 4.1919 (pixel_error: 9.3879)
"""
...
def design():
	model = tf.keras.Sequential([
		...
		tf.keras.layers.Dropout(0.6), # killa
