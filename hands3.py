...
"""
test loss: 0.3256; test avg. pixel err: 4.2911 (pixel_error: 9.6034)
test loss: 0.4085; test avg. pixel err: 4.9191 (pixel_error: 11.0168)
test loss: 0.4341; test avg. pixel err: 5.0203 (pixel_error: 11.2448)
""" # 2 -> 3 added another conv2d layer: 1024 -> 2048
...
def record(history, config):
	...
	record = os.path.join(os.path.dirname(os.getcwd()), "training_records.md")
